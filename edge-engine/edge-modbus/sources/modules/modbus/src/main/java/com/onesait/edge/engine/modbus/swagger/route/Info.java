...
@Api
@Path("/modbus/api/devices/info")
@Produces("application/json")
public class Info implements Route {

	@GET
	@ApiOperation(value = "Get Modbus Info", nickname = "info", tags = "Modbus")
	@ApiImplicitParams({
			@ApiImplicitParam(required = true, dataType = "string", name = "Authorization", paramType = "header") })
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "OK", response = ModbusStatisticalInfo.class),
