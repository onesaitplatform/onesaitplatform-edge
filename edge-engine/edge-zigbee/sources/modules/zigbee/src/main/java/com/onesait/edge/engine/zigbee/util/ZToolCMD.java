...
public class ZToolCMD {
    ...
    /**
    This command is used by tester to build and send an extended data request message*/
    ...
    /**
    This command is used by the tester to set the debug threshold level for a particular software component in the target.*/
    ...
    /**
    This message is issued by the target APS to the tester to report the results of a request to transfer a data PDU from a local NHLE (Next Higher Layer Entity) to a single peer NHLE.*/
    ...
    /**
    This message is issued by the target NWK to the tester to report the results of a request to transfer a data PDU from a local APS sub-layer entity to a single peer APS sub-layer entity.*/
    public static final int NLDE_DATA_CONFIRMATION = 0x4380;
    /**
    This message is issued by the target NWK to the tester to indicate the transfer of a data PDU from the NWK layer to the local APS sub-layer entity.*/
    public static final int NLDE_DATA_INDICATION = 0x4381;
    /**
    This command enables the tester to request the transfer of data from the local APS sub-layer to a peer APS sublayer entity.*/
    ...
    /**
    This command is used by tester to make a request (on behalf of the next higher layer) to read the value of an attribute from the NWK information base (NIB).*/
    ...
    /**
    This command is issued by the target NWK (to tester) to notify the next higher layer of the results of its request to join itself or another device to a network.*/
    public static final int NLME_JOIN_CONFIRMATION = 0x4383;
    /**
    This message is sent by the target to notify the next higher layer of a remote join request.*/
    public static final int NLME_JOIN_INDICATION = 0x4384;
    /**
    This command is used by tester to make a request (on behalf of the next higher layer) to join the device itself or another device to a network.*/
    ...
    /**
    This message is sent by the target to indicate to the next higher layer that the device itself or another device is leaving the network.*/
    public static final int NLME_LEAVE_CONFIRMATION = 0x4385;
    /**
    This message is sent by the target to indicate a remote leave request to the next higher layer of a coordinator*/
    public static final int NLME_LEAVE_INDICATION = 0x4386;
    /**
    This command is used by tester to make a request (on behalf of the next higher layer) that the device itself or another device leave the network.*/
    ...
    /**
    This message is used by the target NWK to inform the tester of the result of a previous association request command*/
    public static final int NLME_NETWORK_FORMATION_CONFIRMATION = 0x4382;
    /**
    This command is used by tester to request (on behalf of the next higher layer) that the device be initiated as a coordinator.*/
    ...
    /**
    This message is sent by the target to indicate network discovery confirmation*/
    ...
    /**
    This command is used by the tester to define how the next higher layer of a coordinator device would permit devices to join its network for a fixed period.*/
    ...
    /**
    This command is used by tester to make a request (on behalf of the next higher layer) that the NWK layer perform a reset operation*/
    ...
    /**
    This command is used by tester to make a request (on behalf of the next higher layer) to set the value of an attribute in the NWK information base (NIB).*/
    ...
    /**
    This message is sent by the target to the next higher layer of the results of its request to start a router*/
    ...
    /**
    This message is sent by the target to indicate a sync request to the next higher layer of a coordinator*/
    public static final int NLME_SYNC_INDICATION = 0x4388;
    /**
    This function is used to inform the upper layers of the initiating device whether its request to associate was successful or unsuccessful.*/
    public static final int NWK_ASSOCIATE_CONFIRMATION = 0x2382;
    /**
    This function is used to indicate the reception of an association request command.*/
    public static final int NWK_ASSOCIATE_INDICATION = 0x2381;
    /**
    This function is used to send parameters contained within a beacon frame received by the MAC sublayer to the next higher layer. The function also sends a measure of the link quality and the time the beacon was received.*/
    ...
    /**
    This function is used to send the results of a request to transfer a data SPDU (MSDU) from a local SSCS entity to a single peer SSCS entity; or multiple peer SSCS entities.*/
    public static final int NWK_DATA_CONFIRMATION = 0x2384;
    /**
    This function indicates the transfer of a data SPDU (MSDU) from the MAC sublayer to the local SSCS entity.*/
    ...
    /**
    This function is used to indicate the reception of a disassociation notification command.*/
    public static final int NWK_DISASSOCIATE_INDICATION = 0x2386;
    /**
    This function allows the MLME to notify the next higher layer of an orphaned device*/
    ...
    /**
    This command is used by the tester to read a single memory location in the target non-volatile memory. The command accepts an address value and returns the memory value present in the target at that address.*/
    ...
    /**
    This command is used by the tester to write to a particular location in non-volatile memory.  The command accepts an address location and a memory value. The memory value is written to the address location in the target.*/
    ...
    /**
    This message is sent to the target in order to test the functions defined for individual applications (which internally use attributes and cluster IDs from various device descriptions).*/
    ...
    /**
    Sends a key event to the device registered application.   The device register application means that the application registered for key events with OnBoard.  Not all application support all keys; so you must know what keys the application supports.*/
    ...
    /**
    Reads current device infromation.*/
    ...
    /**
    Enables or disables the joining permissions on the destination device thus controlling the ability of new devices to join the network.*/
    ...
    /**
    Reads a configuration property from nonvolatile memory (zb_ReadConfiguration).*/
    ...
    /**
    Writes a configuration property to nonvolatile memory (zb_WriteConfiguration).*/
    ...
    /**
    This function will issue a Match Description Request for the requested endpoint outputs.  This message will generate a broadcast message.*/
    ...
    /**
    This callback message is in response to leave device of the network*/
    public static final int ZDO_LEAVE_IND = 0x45C9;    
    /**
    This command will request a device's IEEE 64-bit address.  You must subscribe to 'ZDO IEEE Address Response' to receive the data response to this message.  The response message listed below only indicates whether or not the message was received properly.*/
    ...
    /**
    This command is generated to request a Management Network Discovery Request*/
    ...
    /**
    Response for ZDO_MGMT_NWK_UPDATE_REQUEST*/
    ...
    /**
    This message will request the device to send a "Network Address Request".  This message sends a broadcast message looking for a 16 bit address with a 64 bit address as bait.   You must subscribe to "ZDO Network Address Response" to receive the response to this message.  The response message listed below only indicates whether or not the message was received properly.*/
    ...
    /**
    The command is used for local device to discover the location of a particular system server or servers as indicated by the ServerMask parameter. The destination addressing on this request is 'broadcast to all RxOnWhenIdle devices'.*/
    ...
    /**
    In the case where compiler flag HOLD_AUTO_START is defined by default; device will start from HOLD state. Issuing this command will trigger the device to leave HOLD state to form or join a network.*/
    ...
    /**
    This message is the indication of a source routing.*/
    public static final int ZDO_SRC_RTG_IND = 0x45c4;
    /**
    ...
    /**
    This callback message is in response to the ZDO User Descriptor Set Request.*/
    ...
    /**
    This sends a associat confirm command*/
    public static final int ZMAC_ASSOCIATE_CNF = 0x4282;
    /**
    This command is used to send (on behalf of the next higher layer) an association indication message*/
    public static final int ZMAC_ASSOCIATE_IND = 0x4281;
    /**
    This command is used to request (on behalf of the next higher layer) an association with a coordinator*/
    ...
    /**
    Communcation status indication*/
    ...
    /**
    This command is used to request (on behalf of the next higher layer) a disassociation of the device from the coordinator.*/
    ...
    /**
    This command is used to initialize the ZMAC on the current device (on behalf of the next higher layer).*/
   ...
   public static final int  ZMAC_RX_ENABLE_CNF = 0x428f;
    /**
    This command contains timing information that tells the device when to enable or disable its receiver; in order to schedule a data transfer between itself and another device. The information is sent from the upper layers directly to the MAC sublayer.*/
   ...
   public static final int  ZMAC_SCAN_CNF = 0x428c;
    ...
    /**
    This command is used to request the MAC to transmit beacons and become a coordinator*/
    ...
    /**
     * This command is used to set if the key exchange is required 
     */
    public static final int APP_CNF_BDB_SET_TC_REQUIRE_KEY_EXCHANGE=0x2F09;
    
    /**
     * This command is used to set the target system date and time. 
     * The time can be specified in seconds since 00:00:00 on January 1, 2000 or in parsed date/time components
     */
    public static final int SYS_SET_TIME=0x2110;
    /**
     * This command is used to specify the number of seconds until the timeout expires
     */
    public static final int APP_CNF_SET_DEFAULT_REMOTE_ENDDEVICE_TIMEOUT= 0x2F01;
}
