...
public class FileUtils {
	...
	public static final Boolean loadRxtxLib() {
		...
		if(!isValidRxtxLibraryPath(rxtxPathDetails)) {
			...
			if (url != null) {
				...
				File fileOut = new File(java.lang.System.getProperty("java.io.tmpdir") + SLASH + rxtxPathDetails.get(LIBRARYNAME) + rxtxPathDetails.get(EXTENSION));
				...
				try (InputStream in = url.openStream();
					...
					FileUtils.addLibraryPath(java.lang.System.getProperty("java.io.tmpdir") + SLASH);
					java.lang.System.loadLibrary(rxtxPathDetails.get(LIBRARYNAME));
	...
	private static final Map<String, String> getRxtxLibraryPath() {
		...
		String processor = java.lang.System.getProperty("os.arch");
		String osname = java.lang.System.getProperty("os.name");
		String library = null;
