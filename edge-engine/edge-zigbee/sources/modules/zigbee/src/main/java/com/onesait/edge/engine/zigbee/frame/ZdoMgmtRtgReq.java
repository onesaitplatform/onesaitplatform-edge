...
public class ZdoMgmtRtgReq extends ZFrame implements ZdoZFrame {

	private int startIdx = 0;
	private DoubleByte dstAddr;
	
	public ZdoMgmtRtgReq(DoubleByte dstAddr, int startIdx) {
		...
		super.buildPacket(new DoubleByte(0x25, 0x32), frameData);
	}
	...
	public DoubleByte getZdoCmdId() {
		return ZDOCommand.ManagementRtgRequest;
	}
}
